...
export function prescriptionHtml(
  ...
  * { box-sizing: border-box; } body { font-family: Arial, sans-serif; color:#17212B; font-size:10pt; margin:0; }
  ...
  td strong, td small, td em { display:block; } td small { color:#657476; font-size:8pt; margin-top:3px; } td em { color:#0B716B; font-size:8pt; font-style:normal; margin-top:4px; font-weight:bold; }
   ...
   footer { position:fixed; bottom:0; left:0; right:0; color:#657476; text-align:center; font-size:7pt; } .footer-with-qr { display:flex; align-items:flex-end; justify-content:space-between; min-height:54px; } .footer-text-with-qr { flex:1; text-align:center; margin-right:12px; } .footer-qr { width:54px; height:54px; object-fit:contain; flex:0 0 54px; }
  </style></head><body>
